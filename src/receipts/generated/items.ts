...
export const items: Record<string, Item> = {
  ...
  ferriumBottleYazhenSolution: {
    label: '蓝贴瓶装芽针溶液',
    category: ItemCategory.bottled_solution,
  ...
  amethystOre: {
    label: '紫水晶矿',
    category: ItemCategory.natural_ore,
  ...
  buckflower: {
    label: '荞花',
    category: ItemCategory.natural_plant,
  ...
  buckflowerPowder: {
    label: '荞花粉末',
    category: ItemCategory.plant_powder,
  ...
  buckflowerSeed: {
    label: '荞花种子',
    category: ItemCategory.plant_seed,
